...
export const english: Text = {
  products: {
    ...
    park: {
      title: "Park",
      description:
        "Gives pets the thrill of adventure for some treats, they may find rare relics!",
    ...
    king: {
      title: "King Baby",
      description:
        "Hello human, have a look. Buildings get new upgrades every 5 levels.",
    ...
    museum: {
      title: "Museum",
      description:
        "Welcome Human, your achievement will grow with time. But don't expect any cat puns from me.",
      perArchivement: "Per achievement",
  ...
  relics: {
    ...
    tier0: {
      ...
      relicTier0B: {
        title: "Ball of Rubs",
        description:
          "Adds the Farm's passive love production to Belly Rub Day's base Love gained.",
      },
      relicTier0C: {
    ...
    tier1: {
      ...
      [ids.relicMuseum]: {
        title: "Scratched Map",
        description:
          "A map that leads to an old building, it has scratch marks all over it.",
      },
    },
    tier2: {
  ...
  kingUpgrades: {
    ...
    upgrades: {
      upgradeProduct0A: {
        ...
        description:
          "With my help, your petting power will double. You are welcomed.",
      },
      upgradeProduct1A: {
        title: "Farm Management",
        description:
          "Your farm is looking good, but what if it doubled its passive production...",
      },
      upgradeProduct2A: {
        title: "Lab Management",
        description:
          "Labs like treats right? I can double its Treat production for you.",
      },
      upgradeProduct2B: {
        title: "Lab Activities Management",
        description:
          "I will double your labs passive love production. Their smarts need it.",
      },
      upgradeProduct4A: {
        title: "Park Management",
        description:
          "My doogness, a dragon! Good thing I know how to double its love production.",
      },
      [ids.upgradeProduct5A]: {
        title: "Kingdom Management",
        description:
          "Even I need upgrades. With your help I can double my love production.",
      },
      [ids.upgradeProduct7A]: {
        title: "Feline management",
        description:
          "Getting to a cat can seem hard, but with my help we will double its love production.",
      },
    },
  },
  treeUpgrades: {
    blessings: {
      [ids.blessing0A]: {
        title: "Fond of You",
        description: "Leveling up your Boxes is 10% cheaper.",
      },
      [ids.blessing0B]: {
        title: "Welcome Back Party",
        description:
          "You gain 100% more Patience Points while the game is closed.",
      },
      [ids.blessing0C]: {
        title: "Know them Well",
        description: "Gained 5% more love.",
      },
      [ids.blessing1A]: {
        title: "The Right Spot",
        description: "Increases Petting Power by 10%.",
      },
      [ids.blessing1B]: {
        title: "Farm Expert",
        description: "The Farm prepares events 25% faster.",
      },
      [ids.blessing1C]: {
        title: "Lab Teacher",
        description: "The Lab start with 20 extra points.",
      },
      [ids.blessing2A]: {
        title: "Royal Understanding",
        description: "King Baby's upgrades are 30% cheaper.",
      },
      [ids.blessing2B]: {
        title: "Dragon Motivator",
        description: "Reduces the parks timers 20%",
      },
      [ids.blessing2C]: {
        title: "Feline Rights",
        description: "The Museum produces five times more love.",
      },
    },
  },
  archivements: {
    archivementBaseTitle: "Achievement Unlocked",
    archivemntTitle: "Achievement",
    archivements: {
      ...
      [ids.archivementMuseumLevelMilestone2]: {
        ...
        description:
          "Thank you for sharing your treats and Achievement with this lonely cat human... I will forever be greatful.",
      },
    },
  },
  dogSkins: {
    ...
    skins: {
      initial: {
        ...
        description:
          "The eyes are round and dark, which is in contrast to the triangular or slanted composition of their American counterparts. British Golden Retrievers can have a coat colour of any shade of gold or cream.",
        temperament:
          'They are described as "kindly, friendly and confident". Golden Retrievers make good family pets, particularly as they are patient with children. They are not "one-man dogs" and are generally equally amiable with both strangers and those familiar to them.',
        maxSizeMts: 0.61,
      ...
      [permaIds.dogSkinShiba]: {
        breed: "Shiba Inu",
        description:
          "The Shiba is double coated, with the outer coat being stiff and straight and the undercoat soft and thick. Fur is short and even on the fox-like face, ears, and legs. The purpose of the guard hairs is to protect their underlying skin and to repel rain or snow.",
        temperament:
          "A relatively fastidious breed and feels the need to maintain itself in a clean state. Because of their fastidious and proud nature, Shiba puppies are easy to housebreak and in many cases will housebreak themselves.",
        maxSizeMts: 0.43,
        origin: "Japan",
      },
      [permaIds.dogSkinPug]: {
        breed: "Pug",
        description:
          'Pugs have two distinct shapes for their ears, "rose" and "button". "Rose" ears are smaller than the standard style of "button" ears, and are folded with the front edge against the side of the head. Pugs legs are strong, straight, of moderate length.',
        temperament:
          "Pugs are strong willed but rarely aggressive, and are suitable for families with children. The majority of the breed is very fond of children and sturdy enough to properly play with them. Depending on their owners mood, they can be quiet and docile but also vivacious and teasing.",
        maxSizeMts: 0.3,
        origin: "China",
      },
      [permaIds.dogSkinYorkshireTerrier]: {
        ...
        description:
          "The Yorkshire Terrier is the smallest dog breed of terrier type, and of any dog breed. The typical fine, straight, and silky Yorkshire Terrier coat has also been listed by many popular dog information websites as being hypoallergenic. In comparison with many other breeds",
        temperament:
      ...
      [permaIds.dogSkinShibaFarm]: {
        ...
        description:
          "Back in its days, this shiba was in charge of taking care of a japanese farm.",
        temperament:
          "It used its temperament to guard its farm. Its favorite part of the day was eating with his master near the fireplace.",
        maxSizeMts: 0.43,
        origin: "Japan",
      },
      [permaIds.dogSkinLabLab]: {
        ...
        description:
          "Believe or not, this pupper is the head of its own scientific lab. In it, the pupper and its team make very sciency stuff.",
        temperament:
          "Due to its hyper active nature, this pupper always motivates everyone to make their best sciency science work, making lots of science (and treats).",
        maxSizeMts: 0.31,
      ...
      [permaIds.dogSkinWizPug]: {
        breed: "Pug (Wizard)",
        description:
          "Its breathing problems led him to strength its mind instead of its muscles. Because of that it is able to control time .",
        temperament:
          "Its patience is only rivaled by its power, if its master shows patience to him, amaizing powers await them.",
        maxSizeMts: 0.3,
        origin: "China",
      },
      [permaIds.dogSkinKing]: {
        ...
        description:
          "For what seems like centuries, this dogs family has rule its kingdom, their servants always provide them with food and drink, and also tuck them into bed.",
        temperament:
          "The king favorite activies range between fetching forbidden artifacs and adventuring through its kingdom streets.",
        maxSizeMts: 0.31,
        origin: "United Kingdom (England)",
      },
      [permaIds.dogSkinDragon]: {
        ...
        description:
          "This powerful dragon has rule the park all on its own, nothing can rival its all powerful roar.",
        temperament:
          "Although it doesnt really show it, this dragon really likes going on adventures with its owner and other pets.",
        maxSizeMts: 0.3,
        origin: "Germany, Poland",
      },
    },
