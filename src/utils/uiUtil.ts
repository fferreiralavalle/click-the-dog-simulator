...
export const clearPluses = (
  pluses: Array<plusCurrency>
): Array<plusCurrency> => {
...
export const getBuildingIcon = (building: string): BuildingIcons => {
  switch (building) {
    default:
      return new BuildingIcons(
        "https://i.imgur.com/B00xNnt.png",
        "https://i.imgur.com/6ZO4rY8.jpg"
      );
    case ids.product1Level:
      return new BuildingIcons(
        "https://i.imgur.com/L1eHWfM.png",
        "https://i.imgur.com/G0KXJDf.jpg"
      );
    case ids.product2Level:
      return new BuildingIcons(
        "https://i.imgur.com/ajP1c6E.png",
        "https://i.imgur.com/icoqc1B.jpg"
      );
    case ids.product3Level:
      return new BuildingIcons(
        "https://i.imgur.com/RakeK3M.png",
        "https://i.imgur.com/AIK9tpI.jpg"
      );
    case ids.product4Level:
      return new BuildingIcons(
        "https://i.imgur.com/QJ3nDVL.png",
        "https://i.imgur.com/uenbC1V.jpg"
      );
    case ids.upgradeShop:
      return new BuildingIcons(
        "https://i.imgur.com/4VroGvm.png",
        "https://i.imgur.com/ZskZX6W.jpg"
      );
    case ids.museum:
      return new BuildingIcons(
        "https://i.imgur.com/BJqakl1.png",
        "https://i.imgur.com/uWH6XXJ.jpg"
      );
    case ids.treeOfGoodBoys:
      return new BuildingIcons(
        "https://i.imgur.com/iP4T4aC.png",
        "https://i.imgur.com/zYb3z9n.jpg"
      );
  }
};
...
export const getArchivementIcon = (archivement: string): ArchivementIcons => {
  ...
  switch (archivement) {
    default:
      ...
      return new ArchivementIcons(
        buildingIcon.icon,
        archivementDefaultBackground
      );
