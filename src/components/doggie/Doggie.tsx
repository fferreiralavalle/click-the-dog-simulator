...
import {
  selecters as uiSelecters,
  actions as uiActions,
} from "../../reducers/uiUtils";

import GameManager from "../../game/GameManager";
import { toFormat } from "../../utils/uiUtil";
import { plusCurrency } from "../products/ProductPlus";
import ProductPlusDog, {
  productPlusInterface,
} from "../products/ProductPlusDog";
  ...
  render() {
    ...
    return (
      <div className="doggie-background boxed">
        <DoggiePicture
          selectedDogBreed={selectedDogPicture}
          ref={this.dogPicture}
        />
        ...
        <div
          className="doggie-click"
          onClick={(e: any) => this.onClickedDog(e)}
        />
        <DoggieName />
        <div className="doggie-options">
          {archivementsAmount > 0 && (
            <div
              className="doogie-options-option"
              onClick={this.showArchivements()}
            >
...
const mapStateToProps = (state: any) => ({
  selectedDogPicture: selecters
    .getVariable(state, permaVariables.selectedDogBreed)
    ?.getValue(),
