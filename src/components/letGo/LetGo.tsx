              ...
              <div className="dog-skins-view">
                ...
                <div className={"highlight-field blessing-view-field"}>
                  <span className="highlight-attribute title">
                    {this.text.goodBoyPoints}
                  </span>
                  <span className="highlight-value">
                    {toFormatPure(goodBoyPoints.add(goodBoyPointsPrevious))}
                    <div className="gbp-icon" />
                  </span>
                </div>
                <div className={"highlight-field blessing-view-field"}>
                  <span className="highlight-attribute title">
                    {this.currencies.pattience}
                  </span>
                  <span className="highlight-value">
                    {toFormatPure(patiencePoints)}
                    <div className="patience-icon" />
                  </span>
                </div>
              </div>
              <div className="let-go-options">
                <div className="let-go-option" onClick={this.close()}>
                  {this.text.notYet}
                </div>
                <div
                  className="let-go-option let-go-button"
                  onClick={this.letGo(tree)}
                >
                  {this.text.imReady}
                </div>
              </div>
...
const mapStateToProps = (state: any) => ({
  ...
  patiencePoints: uiVariables
    .getVariable(state, ids.patiencePoints)
    ?.getValue(),
});
