...
import { getText, getArchivementText, getDogSkinText } from '../../utils/textUtil'
import variables from '../../game/VariableId'
import { getArchivementIcon, getDogSkinIcon } from '../../utils/uiUtil'
...
class DogSkinsUI extends Component<IRecipeProps,IState> {
  ...
  handleBreedChoice = (selectedSkin:string) => () =>{
    GameManager.getInstance().setPermaVariable(selectedSkin,permaVariables.selectedDogBreed)
  ...
  render(){
    ...
    return (
      display && <div className="archivements" id="dogSkin" onClick={this.closeArchivements()}>
          <div className="archivements-box">
            <div className="archivements-box-title">
              <span className={"archivements-box-title-text"}>{this.text.breeds}</span>
            </div>
    ...
    return (
        <div className="breed-info">
            <div className={"breed-icon"+lockedClass+hoverClass} style={icon}>
              {unlocked && <div className="breed-info-select"
            ...
            <div className="breed-info-text">
                <div className="breed-info-text-name">
                    {skinText.breed}
                </div>
