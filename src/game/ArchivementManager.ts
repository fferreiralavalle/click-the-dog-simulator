...
export default class ArchivementManager {
  ...
  getArchivements(): Array<ArchivementInterface> {
    const archivements: ArchivementInterface[] = Object.keys(
...
function initializeArchivements(): ArchivementList {
  return {
    ...
    [variables.archivementClicks2]: new Clicks(
      variables.archivementClicks2,
      500
    ),
    [variables.archivementProduct1LevelMilestone]: new FarmMilestone(
      variables.archivementProduct1LevelMilestone,
      milestones[0]
    ),
    [variables.archivementProduct1LevelMilestone2]: new FarmMilestone(
      variables.archivementProduct1LevelMilestone2,
      milestones[1]
    ),
    [variables.archivementProduct2LevelMilestone]: new LabMilestone(
      variables.archivementProduct2LevelMilestone,
      milestones[0]
    ),
    [variables.archivementProduct2LevelMilestone2]: new LabMilestone(
      variables.archivementProduct2LevelMilestone2,
      milestones[1]
    ),
    [variables.archivementProduct3LevelMilestone]: new WizPugMilestone(
      variables.archivementProduct3LevelMilestone,
      1
    ),
    [variables.archivementProduct4LevelMilestone]: new ParkMilestone(
      variables.archivementProduct4LevelMilestone,
      milestones[0]
    ),
    [variables.archivementProduct4LevelMilestone2]: new ParkMilestone(
      variables.archivementProduct4LevelMilestone2,
      milestones[1]
    ),
    [variables.archivementUpgradeShopLevelMilestone]: new KingMilestone(
      variables.archivementUpgradeShopLevelMilestone,
      milestones[0]
    ),
    [variables.archivementUpgradeShopLevelMilestone2]: new KingMilestone(
      variables.archivementUpgradeShopLevelMilestone2,
      milestones[1]
    ),
    [variables.archivementMuseumLevelMilestone]: new MuseumMilestone(
      variables.archivementMuseumLevelMilestone,
      milestones[0]
    ),
    [variables.archivementMuseumLevelMilestone2]: new MuseumMilestone(
      variables.archivementMuseumLevelMilestone2,
      milestones[1]
    ),
  };
}
