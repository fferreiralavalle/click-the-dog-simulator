...
class WizPugMilestone extends ArchivementBase{
    ...
    checkForCompletion() {
        const level = GameManager.getInstance().getVariable(variables.product3Level)?.getValue()
...
export default WizPugMilestone